...
def load_pems_data(rootpath, name, adj_mx_name, ratio=1.0, one_node=False, one_sample=False): # rootpath='data/traffic/data'
    if ratio < 1.0:
        inductive = True
    ...
    datapath = os.path.join(rootpath, name) # datapath = 'data/traffic/data/METR-LA'
    raw_data = {}
