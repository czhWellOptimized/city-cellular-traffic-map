...
# GRU (centralized, 63K)
nohup python main.py --dataset METR-LA --seed 42 --model_name NodePredictor --base_model_name GRUSeq2Seq --batch_size 128 --hidden_size 100 --gru_num_layers 1  --use_curriculum_learning --max_epochs 10 > NodePredictor.log  2>&1 &
...
# GRU (local, 63K)
nohup python main.py --dataset METR-LA --seed 42 --model_name NoFedNodePredictor --base_model_name GRUSeq2Seq --batch_size 128 --hidden_size 100 --gru_num_layers 1 --use_curriculum_learning --mp_worker_num 1 --max_epochs 1 --sync_every_n_epoch 1 > NoFedNodePredictor.log  2>&1 &
...
# GRU (63K) + FedAvg
nohup python main.py --dataset METR-LA --seed 42 --model_name FedAvgNodePredictor --base_model_name GRUSeq2Seq --batch_size 256 --hidden_size 100 --gru_num_layers 1 --use_curriculum_learning --mp_worker_num 1 --max_epochs 1 --sync_every_n_epoch 1 --cl_decay_steps 1 > FedAvgNodePredictor.log  2>&1 &
...
# GRU (63K) + FMTL
nohup python main.py --dataset METR-LA --seed 42 --model_name FixedGraphFedMTLNodePredictor --base_model_name GRUSeq2Seq --batch_size 256 --hidden_size 100 --gru_num_layers 1 --use_curriculum_learning --mp_worker_num 1 --max_epochs 1 --mtl_lambda 0.01 --sync_every_n_epoch 1 > FixedGraphFedMTLNodePredictor.log 2>&1 &
